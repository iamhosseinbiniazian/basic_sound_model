...
flags.DEFINE_string('rbm_layers', '256,256,', 'Comma-separated values for the layers in the sdae.')
...
flags.DEFINE_string('rbm_gibbs_k', '5,', 'Gibbs sampling steps.')
...
flags.DEFINE_integer('finetune_num_epochs', 30, 'Number of epochs.')
